...
public class LoginwithvalidcredentialsPage {
    ...
    public void isHomeScreenLoaded() {
        try {
            boolean isElementDisplayed = elementUtils.isElementDisplayed(homeScreen);
            Assert.assertTrue("Home screen is not loaded!", isElementDisplayed);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void isUserNavigatedToHomeScreen() {
        try {
            boolean isElementDisplayed = elementUtils.isElementDisplayed(homeScreen);
            Assert.assertTrue("User is not navigated to home screen!", isElementDisplayed);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void isGoogleMapDisplayed() {
        try {
            boolean isElementDisplayed = elementUtils.isElementDisplayed(googleMap);
            Assert.assertTrue("Google Map is not displayed!", isElementDisplayed);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void isMenuBarVisible() {
        try {
            boolean isElementDisplayed = elementUtils.isElementDisplayed(menuBar);
            Assert.assertTrue("Menu bar is not visible!", isElementDisplayed);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void isRecenterIconVisible() {
        try {
            boolean isElementDisplayed = elementUtils.isElementDisplayed(recenterIcon);
            Assert.assertTrue("Recenter icon is not visible!", isElementDisplayed);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
