...
Scenario Outline: Open Create New Job Opening Form
  ...
  And I click the Save button
  Then the form should save successfully without any validation errors
  And the job opening should be created with <job_requirements> in the job requirements
...
Examples:
  ...
  @valid-job-opening
  Scenario Outline: Open Create New Job Opening Form
    Given the user fills in the job description with <job_description>
    And the user fills in the job title with <job_title>
    And the user fills in the requirements with <requirements>
    When the user clicks the Save button
    Then the form saves successfully without any validation errors
  ...
  @valid-html-job-opening
  Scenario Outline: Open Create New Job Opening Form
    Given the admin enters "<job_description>" in the job description field
    And the admin fills in "<job_title>" as the job title
    And the admin adds "<requirements>" as the requirements
    When the admin clicks the Save button
    Then the form saves successfully without any validation errors
    And the job opening is created with the HTML tags rendered correctly
  ...
  Scenario Outline: Open Create New Job Opening Form
    ...
    Examples:
      | job_title          | job_description                     | requirements                                      |
      | Software Engineer   | Contact us at hr@example.com       | Experience with automation testing and CI/CD tools. |

  @save_button_disabled
  Scenario Outline: Open Create New Job Opening Form
    Given the job title field is <job_title>
    When the user fills in the job description field with <job_description>
    And the user fills in the job requirements field with <job_requirements>
    Then the Save button should be disabled
    And the Cancel button should remain enabled
  ...
  Scenario Outline: Open Create New Job Opening Form
    ...
    Examples:
      | job_title      | job_description                          | requirements                          |
      | Developer #1   | Job description a Job description a ... | Requirements a Requirements a ...     |

  @error_message_displayed
  Scenario Outline: Open Create New Job Opening Form
    When I enter the job title <job_title>
    And I enter a valid job description <job_description>
    And I enter valid requirements <requirements>
    And I click the Save button
    Then an error message should be displayed indicating the job title exceeds the character limit
    And the Save button should remain disabled
    ...
    Examples:
      | job_title                                                        | job_description                                                                 | requirements                                                                 |
      | This is a very long job title that exceeds the limit           | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa |
...
@duplicate-job-title
Scenario Outline: Open Create New Job Opening Form
  Given the user enters a job title <job_title> that already exists in the system
  And the user fills in the job description <job_description>
  And the user fills in the requirements <requirements>
  When the user clicks the Save button
  Then an error message should be displayed indicating the job title already exists
  ...
  @exceed_character_limit
  Scenario Outline: Open Create New Job Opening Form
    Given the job requirements exceed the maximum character limit
    When I enter <job_requirements> as job requirements
    And I enter <job_title> as job title
    And I enter <job_description> as job description
    And I click the Save button
    Then an error message should be displayed indicating the job requirements exceed the character limit
    And the Save button remains disabled
    ...
    Examples:
      | job_requirements                | job_title          | job_description                                                                                     |
      | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | Software Engineer | We are looking for a skilled software engineer with experience in developing applications. |

  @valid-job-opening
  Scenario Outline: Open Create New Job Opening Form
    Given the admin enters a job title of "<job_title>"
    And the admin enters a job description of "<job_description>"
    And the admin enters job requirements of "<job_requirements>"
    When the admin clicks the Save button
    Then the form saves successfully without any validation errors
    And the job opening is created with all fields populated to their maximum limits
...
Examples:
  ...
  Scenario Outline: Open Create New Job Opening Form
    ...
    And I fill in "<requirements>" in the requirements field
    And I click the Save button
    Then the form should save successfully without any validation errors
...
Scenario Outline: Open Create New Job Opening Form
  ...
  And the admin fills in the job description <job_description>
  And the admin fills in the job requirements <job_requirements>
  When the admin clicks the Save button
  Then the form saves successfully without any validation errors
  And the job opening is created with the job title trimmed of whitespace
  ...
  @valid_job_opening
  Scenario Outline: Open Create New Job Opening Form
    When I enter a job description "<job_description>"
    And I fill in the job title "<job_title>"
    And I fill in the requirements "<requirements>"
    And I click the Save button
    Then the form saves successfully without any validation errors
  ...
  Scenario Outline: Open Create New Job Opening Form
    ...
    Examples:
      | job_description                                               | job_requirements                     |
      | This is a valid job description that meets the requirements. | These are the valid job requirements. |

  @invalid-job-description
  Scenario Outline: Open Create New Job Opening Form
    Given the user enters a job description that exceeds the maximum character limit
    And the user enters valid job title <job_title>
    And the user enters valid requirements <requirements>
    When the user clicks the Save button
    Then an error message is displayed indicating the job description exceeds the character limit
    And the Save button remains disabled
...
Scenario Outline: Open Create New Job Opening Form
  ...
  Scenario Outline: Open Create New Job Opening Form
    ...
    Examples:
      | job_title                                                        | job_description                                                                 | requirements                                                                 |
      | This is a very long job title that exceeds the limit            | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa | aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa |
